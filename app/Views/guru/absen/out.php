                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php if($jadwal != null):?>
                                <?php if($now >= $time_absen && $now <= $time_absen2):?>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div id="my_camera">
                                        </div>
                                        <div class="my-2">
                                            <button type="button" class="btn btn-danger btn-block" id="TakeCapture">
...
var successSound = new Audio('/assets/sound/pulang.mp3');
